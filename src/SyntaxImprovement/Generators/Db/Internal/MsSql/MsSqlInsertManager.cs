...
namespace oledid.SyntaxImprovement.Generators.Db.Internal.MsSql
{
	internal class MsSqlInsertManager<TableType> where TableType : DatabaseTable, new()
	{
		private readonly TableInformation<TableType> tableInformation;

		public MsSqlInsertManager()
		{
