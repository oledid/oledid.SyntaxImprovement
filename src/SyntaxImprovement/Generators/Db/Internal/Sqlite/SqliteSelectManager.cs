...
{
	internal class SqliteSelectManager<TableType> where TableType : DatabaseTable, new()
	{
		...
		public SqliteSelectManager(int? top, IncludeFields<TableType> fieldsToInclude)
		{
			TopOrNull = top;
