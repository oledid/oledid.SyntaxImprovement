...
{
	internal class MsSqlSelectManager<TableType> where TableType : DatabaseTable, new()
	{
		...
		public MsSqlSelectManager(int? top, IncludeFields<TableType> fieldsToInclude)
		{
			TopOrNull = top;
